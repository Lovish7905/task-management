  ...
  return (
    <div className="">
      ...
      <div className="flex h-full w-full">
        ...
        <div className="flex border-solid border-gray-950 w-full  bg-slate-700  sm:justify-evenly md:justify-evenly lg:justify-stretch sm:flex-wrap md:flex-wrap   lg:flex-nowrap ">
          <div
